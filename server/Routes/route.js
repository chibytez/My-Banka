...
const route = (app) => {
     ...
     // transaction route
     app.post('/api/v1/transactions/:accountNumber/debit',verifyToken, userAuth, isAdmin, AdminController.debitAccount );
     app.post('/api/v1/transactions/:accountNumber/credit', verifyToken, userAuth, isAdmin, AdminController.creditAccount);
