...
db.query('CREATE TABLE IF NOT EXISTS accounts(id SERIAL PRIMARY KEY NOT NULL, accountNumber INTEGER, createdon date NOT NULL DEFAULT CURRENT_DATE, owner INTEGER NOT NULL, type VARCHAR(40), status VARCHAR(20) NOT NULL, balance NUMERIC(10,2))', (err, res) => {
  if (err) {
    return err;
  }
});